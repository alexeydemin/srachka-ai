...
| [ ] | Fix commit messages | Auto-commit сообщения кривые (`Step 1: Step 1: ...`). Формат: `<branch> <описание шага>`. Перед PR — squash в один коммит с нормальным сообщением. | | 2026-03-25 |
